...
type Props = {
  form: UseFormReturn<IFilterModulesByDate>;
  setFormData: (data: IFilterModulesByDate) => void;
};

const FilterModulesForm = ({ form, setFormData }: Props) => {
...
export default FilterModulesForm;
