...
type Props = {
  form: UseFormReturn<IFilterSubModulesByDate>;
  setFormData: (data: IFilterSubModulesByDate) => void;
};

const FilterSubModulesForm = ({ form, setFormData }: Props) => {
...
export default FilterSubModulesForm;
